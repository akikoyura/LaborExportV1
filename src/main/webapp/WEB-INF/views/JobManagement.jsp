...
<head>
    ...
    <link href="<c:url value="/resources/css/bootstrap.min.css"/>"
          type="text/css" rel="stylesheet">
<%--    <link rel="stylesheet" href="<c:url value="/resources/libs/multicheck/multicheck.css"/>"/>--%>
<%--    <link rel="stylesheet" href="<c:url value="/resources/libs/datatables.net-bs4/css/dataTables.bootstrap4.css"/>">--%>
...
<script type="text/javascript"
<%--        src="<c:url value="/resources/libs/multicheck/datatable-checkbox-init.js"/> "></script>--%>
<%--<script type="text/javascript" src="<c:url value="/resources/libs/multicheck/jquery.multicheck.js"/>"></script>--%>
<%--<script type="text/javascript" src="<c:url value="/resources/libs/DataTables/datatables.min.js"/> "></script>--%>
