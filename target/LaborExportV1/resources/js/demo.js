...
demo = {
    ...
    showNotification2: function(from, align, text, zindex) {
        color = 4;
    ...
    showInfo: function(from, align,text) {
        color = 1;
    ...
    showInfo2: function(from, align,text,zindex) {
        color = 1;
...
function getCookie(cookieName){
	var name = cookieName + "=";
	return document.cookie.substring(name.length);
}