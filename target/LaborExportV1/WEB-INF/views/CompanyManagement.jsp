...
<div class="wrapper">
    <div class="sidebar desktop"
        ...
        <div class="sidebar-wrapper">
            <div class="logo">
                <a class="simple-text" href="dashboard.html">Labor Export</a>
            </div>
            <ul class="nav">
    ...
    <div class="main-panel">
        <nav class="navbar navbar-expand-lg ">
            ...
            <div class=" container-fluid ">
                <a class="navbar-brand" href="dashboard">Company Management</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="editModalLabel">Add new Employee</h3>
            </div>
...
<div class="modal fade" id="deletemodal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <div class="modal-title" id="deleteModalLabel">Are you sure
                    to delete ?
                </div>
            </div>
            <div class="modal-body">...</div>
